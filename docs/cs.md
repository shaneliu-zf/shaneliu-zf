...
- 小四
  - 開始接觸 App Inventor 2 開發了幾款小遊戲。
- 小五
  - 買了一本 C++ 的書開始學習，對物件導向程式設計有了基礎的理解。
- 小六
  - 嘗試網頁開發，初步接觸了 HTML、CSS、Javascipt。
  - 學習怎麼灌電腦作業系統，開始使用 Linux。
- 國一
  - 接觸 wordpress，開始學習 PHP 後端渲染及網站架設，了解關於域名、虛擬主機等概念。
- 國二
  - 接觸 Java，開始開發 Android 應用程式並陸續上架了幾個程式於 Google Play，現在已經有上萬下載量。
- 高一
  - 加入竹中軟體研究社，並正式開始學習資料結構及演算法。
  - 用 Swift 開發了幾個 iOS 應用程式。
- 高二
  - 擔任竹中軟體研究社社長，開始參加各種程式競賽。
  - 透過學長介紹，旁聽清大「競技程式設計」課程。
  - 因緣際會開始接觸資安，當時在中國最大 CTF 網站 BugkuCTF 排名 42 名。
- 高三
  - 入選台灣好厲駭導師深度輔導模式。
  - 學了多個程式語言，嘗試自己設計程式語言及直譯器，發覺自己對電腦科學的興趣，開始閱讀編譯原理。
  - 特殊選才錄取台北科技大學資工系（唯一名額）。
- 大一
  - 升大一的暑假為一個有上千玩家的線上 TRPG 開發了一套完整的銀行系統，包含於 messenger 上的 ATM 機器人，以及櫃員系統網站。
  - 參加 Global Cybersecurity Camp 2022，小組以 C++ 開發出一款可以躲過現在市面上防毒軟體的木馬程式。
- 大二
  - 參加第八屆全國科技大專校院程式競賽獲得金獎第一名。
  - 加入 Taiwan Kotlin User Group。
  - 擔任 Taiwan Kotlin Conf Watch Party 2023 的主持人之一。
  - 創立臺北科技大學駭客喵喵社。
- 大三
  - 參與鐵人賽並且完賽，主題《那些寫程式的宗教戰爭》。
  - 參加 ICPC2023 台灣站獲得銅獎。
  - Android Taipei《Clean Code：如何寫好一個程式》。
  - 參加第九屆全國科技大專校院程式競賽獲得金獎第三名。
- 大四
  - 參加 ICPC2024 台灣站獲得銅獎第一名。
  - Kotlin Meetup 講者《這不是你平常寫的 Kotlin：Code Golf 的黑魔法》。
  - COSCUP 2025 JVM 台灣代表隊 JVM 閃電講講者《這不是你平常寫的 Kotlin：Code Golf 的黑魔法》。
  - 考試錄取清華大學資訊安全研究所。
- 碩一
  - 加入清華大學資訊安全實驗室 IS Lab，指導老師為孫宏民教授。
  - AIS3 Junior 2026 講師。
  - COSCUP 2026 講者《打造你自己的 Kotlin DSL》。
  - 在 IBM 擔任 Associate Application Consultant Summer Intern。
  - 申請逕讀資工系博士學位。
- 博一
  - To be Continued
...
- 2023 TUPC 全國科技大專校院程式競賽 冠軍（第八屆金獎第一名）
- 2024 TUPC 全國科技大專校院程式競賽 金獎第三名
- ICPC 2023 / 2024 台灣站 銅獎（2024 為銅獎第一名）
- 資訊奧林匹亞選手海選 滿分
- 高級中學數理及資訊學科能力競賽資訊科校內初賽 第一名（2019）
- BugkuCTF 最高排名 42 名
...
| AIS3 pre-exam                  | 資安（CTF） | 2025 | 第99名     |
| AIS3 pre-exam                  | 資安（CTF） | 2026 | 第50名     |
...
| **專案名稱**      | **功能**                                              | **語言**   | **連結**                                                                              |
| ------------- | --------------------------------------------------- | -------- | ----------------------------------------------------------------------------------- |
| 馬會貨幣系統        | 升大一的暑假為一個有上千玩家的線上 TRPG 開發了一套完整的銀行系統，包含於 messenger 上的 ATM 機器人，以及櫃員系統網站。 | PHP      |                                                                                     |
