...
資訊工程：程式語言、演算法、資訊安全、CTF、Code golf、手機應用軟體開發、網站前後端開發及架設維護、電腦科學

魔術：近距離魔術、硬幣、撲克牌、催眠、心靈、千術

手部極限運動：魔術方塊、溜溜球、劍玉、蝴蝶刀、花式切牌、競技疊杯、雜耍球
...
- 高一
  - 參加竹中軟體研究社，重新拾回 C++ ，並開始學習資料結構及演算法。
  - 用 Swift 做了幾個iOS應用程式。
...
- 大一
  ...
  - 參加Global Cybersecurity Camp，小組以C++開發出一款可以躲過防毒軟體的木馬程式。
